    (function() {
      const bootstrapNode = document.getElementById("kaMainBootstrap");
      let bootstrap = {};
      if (bootstrapNode) {
        try {
      ...
      const initialTab = String(bootstrap.initialTab || "overview");
      ...
      const SHARED_TRACKER_PHASE_LABELS = {
        ...
        w15: "W15",
            ...
            let OPS_SPECIAL_CHECKLISTS = bootstrap.opsSpecialChecklists || {};
