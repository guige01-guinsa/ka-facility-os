...
W13TrackerStatus = Literal["pending", "in_progress", "done", "blocked"]
W13CompletionStatus = Literal["active", "completed", "completed_with_exceptions"]
W14TrackerStatus = Literal["pending", "in_progress", "done", "blocked"]
...
class W13TrackerBootstrapRequest(BaseModel):
    site: str = Field(min_length=1, max_length=120)


class W13TrackerItemUpdate(BaseModel):
    assignee: Optional[str] = Field(default=None, max_length=120)
    status: Optional[W13TrackerStatus] = None
    completion_checked: Optional[bool] = None
    completion_note: Optional[str] = Field(default=None, max_length=4000)


class W13TrackerItemRead(BaseModel):
    id: int
    site: str
    item_type: str
    item_key: str
...
class W13EvidenceRead(BaseModel):
    id: int
    tracker_item_id: int
    site: str
    file_name: str
...
class W13TrackerBootstrapResponse(BaseModel):
    site: str
    created_count: int
    total_count: int
    items: list[W13TrackerItemRead]


class W13TrackerOverviewRead(BaseModel):
    site: str
    total_items: int
    pending_count: int
    in_progress_count: int
...
class W13TrackerCompletionRequest(BaseModel):
    site: str = Field(min_length=1, max_length=120)
    completion_note: Optional[str] = Field(default=None, max_length=4000)
    force: bool = False


class W13TrackerReadinessRead(BaseModel):
    site: str
    checked_at: datetime
    total_items: int
    pending_count: int
...
class W13TrackerCompletionRead(BaseModel):
    site: str
    status: W13CompletionStatus
    completion_note: str
    completed_by: Optional[str] = None
    completed_at: Optional[datetime] = None
    force_used: bool = False
...
class W14TrackerBootstrapRequest(BaseModel):
    site: str = Field(min_length=1, max_length=120)


class W14TrackerItemUpdate(BaseModel):
    assignee: Optional[str] = Field(default=None, max_length=120)
    status: Optional[W14TrackerStatus] = None
    completion_checked: Optional[bool] = None
    completion_note: Optional[str] = Field(default=None, max_length=4000)


class W14TrackerItemRead(BaseModel):
    id: int
    site: str
    item_type: str
    item_key: str
...
class W14EvidenceRead(BaseModel):
    id: int
    tracker_item_id: int
    site: str
    file_name: str
...
class W14TrackerBootstrapResponse(BaseModel):
    site: str
    created_count: int
    total_count: int
    items: list[W14TrackerItemRead]


class W14TrackerOverviewRead(BaseModel):
    site: str
    total_items: int
    pending_count: int
    in_progress_count: int
...
class W14TrackerCompletionRequest(BaseModel):
    site: str = Field(min_length=1, max_length=120)
    completion_note: Optional[str] = Field(default=None, max_length=4000)
    force: bool = False


class W14TrackerReadinessRead(BaseModel):
    site: str
    checked_at: datetime
    total_items: int
    pending_count: int
...
class W14TrackerCompletionRead(BaseModel):
    site: str
    status: W14CompletionStatus
    completion_note: str
    completed_by: Optional[str] = None
    completed_at: Optional[datetime] = None
    force_used: bool = False
...
class W15TrackerBootstrapRequest(BaseModel):
    site: str = Field(min_length=1, max_length=120)


class W15TrackerItemUpdate(BaseModel):
    assignee: Optional[str] = Field(default=None, max_length=120)
    status: Optional[W15TrackerStatus] = None
    completion_checked: Optional[bool] = None
    completion_note: Optional[str] = Field(default=None, max_length=4000)


class W15TrackerItemRead(BaseModel):
    id: int
    site: str
    item_type: str
    item_key: str
...
class W15EvidenceRead(BaseModel):
    id: int
    tracker_item_id: int
    site: str
    file_name: str
...
class W15TrackerBootstrapResponse(BaseModel):
    site: str
    created_count: int
    total_count: int
    items: list[W15TrackerItemRead]


class W15TrackerOverviewRead(BaseModel):
    site: str
    total_items: int
    pending_count: int
    in_progress_count: int
...
class W15TrackerCompletionRequest(BaseModel):
    site: str = Field(min_length=1, max_length=120)
    completion_note: Optional[str] = Field(default=None, max_length=4000)
    force: bool = False


class W15TrackerReadinessRead(BaseModel):
    site: str
    checked_at: datetime
    total_items: int
    pending_count: int
...
class W15TrackerCompletionRead(BaseModel):
    site: str
    status: W15CompletionStatus
    completion_note: str
    completed_by: Optional[str] = None
    completed_at: Optional[datetime] = None
    force_used: bool = False
